...
**Overview:** Frosted translucent surfaces floating over a vivid, colorful background. Depth comes from blur + light borders, not shadows. One hard rule governs everything: **readability first, glass second — never more than 2 glass surfaces per view.**

**Visual principles:** frosted translucency · colorful gradient backdrop · light borders (white alpha) · soft elevation · airy spacing · glass is a highlight, not a layout system.
...
- **Responsive:** glass blur cost is real on mobile — drop to 1 glass surface or replace with solid surface below 720px; H1→34px.
...
## Anti AI-slop (glassmorphism edition)
